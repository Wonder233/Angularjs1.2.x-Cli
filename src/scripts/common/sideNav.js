/**
 * Created by Wonder on 2018-7-31.
 * @name:    powerPlant  左边栏菜单navJS
 * @author:  Wonder
 */
                    ...
                    $(res.data).each(function(k, v) {
                        ...
                        if (v.subset) {
                            ...
                            $(v.subset).each(function(ko, vo) {
                                view += '<dd ui-sref-active="layui-this">';
                                if (vo.target) {
                                    view += '<a href="' + vo.href + '" target="_blank">';
                                } else {
                                    view += '<a href="javascript:;" data-id="' + vo.id + '" ui-sref="' + vo.href + '">';
                                }
                            ...
                            if (v.target) {
                                ...
                                view += '<a href="javascript:;" ui-sref="' + v.href + '})">';
                            }
